...
class AffordanceGapEnv(BaseBenchmark):
    """
    9. Affordance-gap invention task.
    Under impasse, the agent must output u > 0.5 to bridge the affordance gap
    (e.g., unlocking a door) and proceed to the reward.
    """
    def setup_task(self):
        # Wall/Door at y=0.3
